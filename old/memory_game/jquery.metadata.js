 ...
 *
 * Revision: jQuery.d: jquery.metadata.js 3640 2007-10-11 18:34:38Z pmclanahan $
 *
 */
 ...
 * @after jQuery."#one").metadata().item_id == 1; $("#one").metadata().item_label == "Label"
 ...
 * @before jQuery.metadata.setType("html5")
 * @after jQuery."#one").metadata().item_id == 1; $("#one").metadata().item_label == "Label"
  ...
  metadata : {
    ...
    get: function( elem, opts ){
      ...
      if ( settings.type == "html5" ) {
        var object = {};
        jQuery(elem.attributes ).each(function() {
      ...
      jQuery.data( elem, settings.single, object );
      return object;
    }
  }
});
